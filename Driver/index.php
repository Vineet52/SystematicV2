...
<body class="bg-customGrey">
              ...
              <div class="text-center text-muted mb-4">
                ...
                <form method='post' action="">
                  ...
                  <div class="text-center">
                    <button  class="btn btn-default my-4" id="login_button">Log in</button>
                  </div>
                </form>
            </div>
          </div>
  ...
  <div class="modal loadingModal fade bd-example-modal-lg justify-content-center" tabindex="-1">
