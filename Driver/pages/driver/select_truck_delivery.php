        ...
        <div class="col">
          <div class="card shadow col">
            <div class="card-header bg-transparent">
              <h3 class="mb-0">Delivery Truck Selection</h3>
            </div>
            <div class="card-body">    
              <br>          
              ...
              <div class="col mt-4 text-center">
                <button class="btn btn-icon btn-2 btn-default mt-0" type="button" data-dismiss="modal" data-toggle="modal" data-target="#finalise" id="btnSelectTruck">
            ...
            <div class="modal fade" id="finalise" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <form action="list_delivery.php" method="GET">
